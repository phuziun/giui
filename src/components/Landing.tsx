...
// LARGE, DIM, overlapping emitters behind the bar. Small bright ones acted like
// point sources and the bar edge exited their light as a hard bright rim; big
...
export function NavGlow() {
  ...
  return (
    <div style={{ position: "absolute", inset: -28, pointerEvents: "none" }} aria-hidden>
      {NAV_BLOBS.map((b, i) => {
